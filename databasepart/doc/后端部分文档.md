...
返回的json格式:{"movie_name": "电影名称" string类型, "release_year": "发行年份" number类型, "genre_list": "所属类别" 数组类型, "avg_rating": "平均分" number类型, "vote_count": "投票人数" number类型, "short_comment": "AI短评" string类型, "success": "修改结果" boolean类型， "message": "提示信息" string}
```
